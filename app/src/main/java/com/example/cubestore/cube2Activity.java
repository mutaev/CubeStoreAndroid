...
public class cube2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backblog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(cube2Activity.this, AllCategory.class);
                startActivity(i);
            }
        });
    ...
    private class Content extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPostExecute(Void unused) {
            ...
            parseItemAdapter = new ParseItemAdapter(parseItemModelList, cube2Activity.this);
        ...
        protected Void doInBackground(Void... voids) {
            try {
                String url = "https://zakubi.com/Po_razmeru/2-na-2";//https://rtdev.xyz/
